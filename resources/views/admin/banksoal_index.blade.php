...
<div class="row justify-content-center">
  <div class="col-md-12">
    <div class="card shadow-lg p-3">
      ...
      <p>Disini Anda bisa membuat, merubah dan mengarsipkan paket soal ujian, lengkap dengan daftar pertanyaan berserta
        pilihan
        jawaban.
        Untuk soal text bisa langsung diimport menggunakan template excel, lalu untuk gambar dan audionya bisa diinput
        secara
        manual.</p>
    </div>
    {{-- card table --}}
