        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ \Route::is('Kelompo.*') ? 'active' : '' }}">
                        <a href="{{ route('kelompok.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Basic">Alur Aplikasi</div>
                        </a>
                    </li>

                    <li class="menu-item {{ \Route::is('kelompok.*') ? 'active' : '' }}">
                        <a href="{{ route('kelompok.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Basic">Data Kelompok</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item {{ \Route::is('banksoal.*') ? 'active' : '' }}">
                        <a href="{{ route('banksoal.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Basic">Bank Soal</div>
                        </a>
                    </li>
                    <li class="menu-item {{ \Route::is('kelasujian.*') ? 'active' : '' }}">
                        <a href="{{ route('kelasujian.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Basic">Kelas Ujian</div>
                        </a>
                    </li>
                    <li class="menu-item {{ \Route::is('Kelompo.*') ? 'active' : '' }}">
                        <a href="{{ route('kelompok.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Basic">Profil Sekolah</div>
                        </a>
                    </li>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="layouts-without-menu.html" class="menu-link">
                                    <div data-i18n="Without menu">Sub 1</div>
                                </a>
                            </li>
                            <li class="menu-item">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <span class="badge bg-danger rounded-pill badge-notifications">a</span>
                                </a>
